                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12">
                                            <div class="ui search focus mt-30 lbel25">
                                                ...
                                                <div class="ui left icon input swdh19">
                                                    <input class="prompt srch_explore" type="text" placeholder="entre com o nome" name="sala_nome">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12">
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            ...
                                            <div class="save_content">
                                                <button class="save_content_btn" type="button" id="addRoom" onclick="createRoom()"><span class='state'>Salvar</span></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
