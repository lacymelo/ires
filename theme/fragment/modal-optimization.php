...
?>
<div id="modal-optimization" class="modal modal-edu-general default-popup-PrimaryModal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header header-color-modal bg-color-1">
                <h4 class="modal-title" id="title_modal_message">
                    <p> <i class="fla-2x flaticon-settings"></i> SALVAR CONFIGURAÇÕES</p>
                </h4>
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary confirm-configuration" onclick="saveNetwork()"><span class="state-save">Confirmar</span></a>
            </div>
        </div>
    </div>
</div>